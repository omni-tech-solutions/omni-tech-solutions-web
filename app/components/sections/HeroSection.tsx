    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 pointer-events-none overflow-hidden">
                <div
                    className="hero-orb hero-orb-1 absolute w-[600px] h-[600px] rounded-full"
                    style={{
                ...
                />
                <div
                    className="hero-orb hero-orb-2 absolute w-[500px] h-[500px] rounded-full"
                    style={{
                ...
                />
                <div
                    className="hero-orb hero-orb-3 absolute w-[350px] h-[350px] rounded-full"
                    style={{
                        background: `radial-gradient(circle, ${COLORS.primary}, transparent 70%)`,
            ...
            <div className="relative z-10 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-20 sm:py-24 lg:py-28">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
                    ...
                    <div className="lg:col-span-7 space-y-6 sm:space-y-7">
                        ...
                        {/* Badge */}
                        <div
                            className="hero-fade-in inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium"
                            style={{
                        ...
                        {/* Headline */}
                        <h1
                            className="hero-fade-in text-4xl sm:text-5xl lg:text-6xl font-bold leading-[1.1] tracking-tight"
                        ...
                        {/* Accent bar */}
                        <div
                            className="hero-fade-in w-16 h-1 rounded-full"
                            style={{
                        ...
                        {/* Description */}
                        <p
                            className={`hero-fade-in ${colors.textSec} text-base sm:text-lg leading-relaxed max-w-xl`}
                        ...
                        {/* CTA Buttons */}
                        <div
                            className="hero-fade-in flex flex-col sm:flex-row gap-3 sm:gap-4"
                            style={{ animationDelay: '300ms' }}
                        >
                            <a
                                href="#contact"
                                className="group relative inline-flex items-center justify-center gap-2 px-7 py-3.5 font-semibold text-base text-white rounded-xl overflow-hidden transition-all duration-300 hover:scale-[1.03] hover:shadow-2xl focus:outline-none focus:ring-2 focus:ring-[#ff6b1a] focus:ring-offset-2"
                                style={{
                            ...
                            <a
                                href="#services"
                                className={`inline-flex items-center justify-center gap-2 px-7 py-3.5 ${colors.card} border-2 ${colors.borderLight} font-semibold text-base rounded-xl transition-all duration-300 hover:scale-[1.03] ${colors.cardHover} backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-[#ff6b1a] focus:ring-offset-2`}
                            >
                                {t('hero.learnMore')}
                            </a>
                        </div>
                        ...
                        {/* Trust badges row */}
                        <div
                            className="hero-fade-in flex flex-wrap items-center gap-3 pt-2"
                    ...
                    {/* Right — Stats cards, stacked with visual interest */}
                    <div className="lg:col-span-5">
                        <div
                            className="hero-fade-in grid grid-cols-2 lg:grid-cols-1 gap-4"
                            style={{ animationDelay: '450ms' }}
                        >
                            {/* Rating card */}
                            <div
                                className={`p-5 rounded-2xl backdrop-blur-sm border ${colors.borderLight}`}
                                style={{
                            ...
                            >
                                ...
                                <span className={`${colors.textSec} text-sm font-medium`}>
                                    {t('hero.rating')}
                                </span>
                            </div>
                            ...
                            >
                                <span
                                    className="text-3xl lg:text-4xl font-bold bg-clip-text text-transparent block mb-1"
                                    style={{
                            ...
                            {/* Quality card — spans full width on the 2-col mobile grid */}
                            <div
                                className={`col-span-2 lg:col-span-1 p-5 rounded-2xl backdrop-blur-sm border ${colors.borderLight}`}
                                style={{
                                    backgroundColor: isDark ? 'rgba(255,255,255,0.03)' : 'rgba(255,255,255,0.7)',
                                }}
                            >
                                <div className="flex items-center gap-3">
                                    ...
                                    >
                                        <Award className="w-5 h-5" style={{ color: COLORS.primary }} strokeWidth={2} />
                                    </div>
                                    <div>
                                        <span className={`${colors.text} text-sm font-semibold block`}>
                                            {t('hero.projects')}
                                        </span>
                                        <span className={`${colors.textSec} text-xs`}>
