    ...
    return (
        <section id="home" className="relative flex items-center min-h-[80svh] pt-20">
            <div className={`omni-reveal ${CONTAINER} w-full py-20 sm:py-28 text-center`}>
                <p className={`text-sm font-semibold uppercase tracking-wider mb-5 ${colors.textTer}`}>
                    {t('hero.badge')}
                </p>
                ...
                <div className="mt-10 flex flex-col sm:flex-row gap-3 justify-center">
                    ...
                    <a
                        href="#services"
                        className={`inline-flex items-center justify-center px-7 py-3.5 font-semibold rounded-xl border ${colors.border} ${colors.text} transition-colors duration-200 hover:border-zinc-400 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#ff6b1a] focus-visible:ring-offset-2`}
                    >
                        {t('hero.learnMore')}
                    </a>
                </div>
