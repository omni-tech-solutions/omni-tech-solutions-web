    ...
    return (
        <section id="home" className="relative flex items-center min-h-[80svh] pt-20 overflow-hidden max-sm:bg-zinc-950">
            <div className={`omni-reveal relative ${CONTAINER} w-full py-20 sm:py-28 text-center`}>
                <p className={`text-sm font-semibold uppercase tracking-wider mb-5 ${colors.textTer} max-sm:text-[#ff8a58]`}>
                    {t('hero.badge')}
                </p>
                ...
                <div className="mt-10 flex flex-col sm:flex-row gap-3 justify-center">
                    <a
                        href="#contact"
                        className="group inline-flex items-center justify-center gap-2 px-7 py-3.5 font-semibold text-white rounded-xl transition-colors duration-200 hover:bg-[#e85d0f] max-sm:shadow-[0_12px_30px_-10px_rgba(255,107,26,0.7)] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#ff6b1a] focus-visible:ring-offset-2"
