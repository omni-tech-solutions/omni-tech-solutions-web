...
export const Header: React.FC<HeaderProps> = ({ theme, toggleTheme, colors, activeSection: scrolledSection }) => {
    ...
    return (
        <nav className={`fixed w-full ${colors.nav} backdrop-blur-xl z-50 border-b ${colors.borderLight} max-md:bg-[#1d1d20]/90 max-md:border-zinc-600 transition-all duration-300`}>
            <div className={CONTAINER}>
              ...
              OMNI Tech Solutions
                ...
                {/* Mobile Menu */}
                {isMenuOpen && (
                    <div className="md:hidden pb-4 border-t border-zinc-600 animate-fadeIn">
                        ...
                        <div className="flex items-center justify-between mt-4 pt-4 border-t border-zinc-600">
